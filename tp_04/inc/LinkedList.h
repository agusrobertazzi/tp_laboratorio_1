...
int ll_len(LinkedList* this); // OK
Node* test_getNode(LinkedList* this, int nodeIndex);
int test_addNode(LinkedList* this, int nodeIndex,void* pElement);
int ll_add(LinkedList* this, void* pElement); // OK
void* ll_get(LinkedList* this, int index); // OK
int ll_set(LinkedList* this, int index,void* pElement); // OK
